...
import { DarkColors, LightColors, useColors } from './Components/Elements/Themes/Colors';
...
function App() {
  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      ...
      <PaperProvider theme={isDarkTheme ? customPaperDarkTheme : customPaperTheme}>
        <NavigationContainer theme={isDarkTheme ? customNavigationDarkTheme : customNavigationTheme}
        >
          <Stack.Navigator screenOptions={{ headerShown: false }}>
            ...
            <Stack.Screen name='CompleteTransaction' component={CompleteTransaction} />
            <Stack.Screen name='Transfer' component={Transfer} />
            <Stack.Screen name='ShowTransaction' component={ShowTransaction} options={{
              animationEnabled: true, animation: 'slide_from_bottom',
              gestureEnabled: true,
              presentation: 'modal',
              ...(TransitionPresets.ModalPresentationIOS)
