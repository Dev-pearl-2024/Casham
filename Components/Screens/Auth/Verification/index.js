...
const Verification = (props) => {
    ...
    return (
        <SafeAreaView style={[stylesheet.container, {
            ...
            <View style={{
                ...
                <View style={{ alignSelf: 'flex-start' }}>
                    ...
                    <Text style={[stylesheet.title, {
                        alignSelf: 'flex-start'
                    }]}>Verify OTP sent to  <Text style={[stylesheet
                        .title, {
                    ...
                    <Text style={{
                        ...
                        fontSize: 14,
                        color: 'gray'
                    }}>Securely log in with your One Time Password {"(OTP)"} to access your account.</Text>
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <TextInput value={code1}
                                ...
                                cursorColor={"gray"} ref={code1Ref} maxLength={1} />
                        </View>
                        <View style={{
                            alignItems: 'center', justifyContent: 'center',
                            width: Dimensions.get('window').width / 8
                            ...
                            <TextInput value={code2}
                                inputMode="numeric"
                                textAlign="center"
                                selectTextOnFocus onChangeText={(tx) => {
                                    setCode2(tx)
                                    if (tx) {
                                ...
                                cursorColor={"gray"} ref={code2Ref} maxLength={1} />
                        </View>
                        <View style={{
                            alignItems: 'center', justifyContent: 'center',
                            width: Dimensions.get('window').width / 8
                            ...
                            <TextInput value={code3}
                                ...
                                cursorColor={"gray"} ref={code3Ref} maxLength={1} />
                        </View>
                        <View style={{
                            alignItems: 'center', justifyContent: 'center',
                            width: Dimensions.get('window').width / 8
                            ...
                            <TextInput value={code4}
                                ...
                                cursorColor={"gray"} ref={code4Ref} maxLength={1} />
                        </View>
                        <View style={{
                            alignItems: 'center', justifyContent: 'center',
                            width: Dimensions.get('window').width / 8
                            ...
                            <TextInput value={code5}
                                ...
                                cursorColor={"gray"} ref={code5Ref} maxLength={1} />
                        </View>
                        <View style={{
                            alignItems: 'center', justifyContent: 'center',
                            width: Dimensions.get('window').width / 8
                            ...
                            <TextInput value={code6}
                                ...
                                cursorColor={"gray"} ref={code6Ref} maxLength={1} />
                        </View>
                    </View>
                    <TouchableOpacity
                        style={{
            ...
            <CustomSnackbar onDismissSnackbar={onDismissSnackbar}
                title={snackMessage} visible={snackVisible} label={"Okay"} />
