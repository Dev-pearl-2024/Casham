        ...
        return (
            <>
                {transactionsData?.map((item, index) => {
                    ...
                    return <TouchableScale key={index} style={{
                        width: '90%',
                        height: 70,
                        ...
                        <View style={{
                            ...
                            backgroundColor: data?.name !== item.originName ? '#9EDF9C' : '#f8cccc', alignItems: 'center',
                            justifyContent: 'center'
                        }}>
                            {data?.name !== item.originName ? <AntDesign name="caretdown" size={20} color={"green"} /> : <AntDesign name="caretup" size={20} color={"red"} />
                        ...
                        <View style={{ flex: 0.8 }}>
                            ...
                            <Text>{data?.name === item.originName ? item.recipientName : item.originName}</Text>
                        </View>
                        <View>
    ...
    const DashboardCard = () => {
        return (
            <View style={{
                ...
                <Card style={{
                    marginTop: 10, width: Dimensions.get('window').width - 30,
                    ...
                    <Image source={require('../../../Elements/Images/dashframe.png')}
                        style={{
                            position: 'absolute',
                            top: 0, left: 0,
                        ...
                        <View>
                            ...
                            <View style={{
                                ...
                                <Text style={{
                                    ...
                                    fontWeight: 'bold',
                                    color: 'white'
                                }}>{parseInt(balance).toLocaleString()}</Text>
                            </View>
                        </View>
                    </View>
                    <View style={{
    ...
    return (
        <SafeAreaView style={[stylesheet.container, {
            ...
            <Text style={{
                ...
                fontWeight: "bold",
                marginBottom: 20,
                marginTop: 110, alignSelf: 'flex-start',
                marginStart: 20
            }}>Overview</Text>
            <ScrollView
                horizontal
