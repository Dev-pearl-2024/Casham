import { Animated, Appearance, Dimensions, Easing, Image, TouchableOpacity, View } from "react-native"
          ...
          >
            ...
            <TouchableOpacity style={{
              ...
              <Image source={
                ...
                style={{
                  width: page == 'Home' ? 25 : 20, height: page == 'Home' ? 25.41 : 20.33
                }} />
              <Text style={{
                marginTop: 5,
                color: themeState == 'dark' ?
                  page == 'Home' ? 'white' : 'gray' :
                  page == 'Home' ? 'black' : 'gray'
              }}>Home</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{
              alignItems: 'center',
              ...
              <Feather name="arrow-down-left" size={page == 'Deposit' ?
                25 : 20
              }
                color={themeState === 'dark' ? page == 'Deposit' ? 'green' : 'green' : page == 'Deposit' ? 'green' : 'green'} />

              <Text style={{
                marginTop: 5,
                color: themeState == 'dark' ?
                  deposit ? 'white' : 'lightgreen' :
                  deposit ? 'black' : 'green'
              }}>Received</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{
              ...
              <Feather name="arrow-up-right" size={
                page == 'Withdraw' ? 25 : 20
              }
                color={themeState === 'dark' ? page == 'Withdraw' ? 'red' : 'red' : page == 'Withdraw' ? 'red' : 'red'} />

              <Text style={{
                marginTop: 5,
                color: themeState == 'dark' ?
                  page == 'Withdraw' ? 'white' : 'lightred' :
                  page == 'Withdraw' ? 'red' : 'red'
              }}>Sent</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{
              alignItems: 'center',
              ...
              <Ionicons name={page == 'Settings' ? "settings" : 'settings-outline'} size={
                page == 'Settings' ? 25 : 20
              }
                color={themeState === 'dark' ? page == 'Settings' ? 'white' : 'gray' : page == 'Settings' ? 'black' : 'gray'} />

              <Text style={{
                marginTop: 5,
                color: themeState == 'dark' ?
                  page == 'Settings' ? 'white' : 'gray' :
                  page == 'Settings' ? 'black' : 'gray'
              }}>Settings</Text>
            </TouchableOpacity>
